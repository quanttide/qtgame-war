...
class UnitView extends StatelessWidget {
  ...
  const UnitView({super.key, required this.state});
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        Text('${u.name}${u.hasActed ? ' (\u2713)' : ''}',
                            style: TextStyle(
                                fontSize: 9.5, fontWeight: FontWeight.w600, fontFamily: 'serif',
                  ...
                  Row(
                    children: List.generate(u.maxHp, (i) => Container(
                      width: 6, height: 6, margin: const EdgeInsets.only(left: 1),
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
